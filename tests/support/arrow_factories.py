"""Synthetic single-row Arrow table factories used across the suite.

All data is tiny, synthetic, and in-memory. No network, no disk data, no
downloaded fixtures, no pandas.
"""
