...
class TestCombinedJoins:
    def test_combined_wikipedia_and_wikivoyage(self):
        ...
        wp_docs = rows_to_table([
            make_wikipedia_document_row(document_id="doc-wp-1", article_id="art-wp-1", wikidata="Q889"),
        ], WIKIPEDIA_DOCUMENTS_SCHEMA)
        
        wp_sections = rows_to_table([
            make_section_row(section_id="sec-wp-1", document_id="doc-wp-1", article_id="art-wp-1", section_index=0),
        ], SECTIONS_SCHEMA)
        ...
        wv_sections = rows_to_table([
            make_section_row(section_id="sec-wv-1", document_id="doc-wv-1", article_id="", project="wikivoyage", site="en.wikivoyage.org", section_index=0),
        ], SECTIONS_SCHEMA)
    ...
    def test_determinism_under_shuffle(self):
        ...
        pa_list = [
            make_polygon_article_row(polygon_id="poly-2", article_id="art-2", wikidata="Q2"),
            make_polygon_article_row(polygon_id="poly-1", article_id="art-1", wikidata="Q1"),
        ]
        wp_doc_list = [
            make_wikipedia_document_row(document_id="doc-wp-2", article_id="art-2", wikidata="Q2", language="en"),
            make_wikipedia_document_row(document_id="doc-wp-1", article_id="art-1", wikidata="Q1", language="en"),
        ]
        wp_sec_list = [
            make_section_row(section_id="sec-wp-2b", document_id="doc-wp-2", article_id="art-2", wikidata="Q2", section_index=1),
            make_section_row(section_id="sec-wp-2a", document_id="doc-wp-2", article_id="art-2", wikidata="Q2", section_index=0),
            make_section_row(section_id="sec-wp-1", document_id="doc-wp-1", article_id="art-1", wikidata="Q1", section_index=0),
        ]
